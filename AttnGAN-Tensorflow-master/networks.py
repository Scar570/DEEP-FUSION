...
class DownBlock(tf.keras.layers.Layer):
    ...
    def architecture(self):
        ...
        model += [BatchNorm(name='batch_norm')]
        model += [Leaky_Relu(alpha=0.2,name='leaky_relu_1')]
...
class Discriminator_64(tf.keras.layers.Layer):
    ...
    def architecture(self):
        ...
        model += [Leaky_Relu(alpha=0.2,name='leaky_relu_2')]
        ...
        for i in range(3):
            ...
            if(i==0) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_3')]
            if(i==1) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_4')]
            if(i==2) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_5')]
        ...
        code_block += [Leaky_Relu(alpha=0.2,name='leaky_relu_6')]
...
class Discriminator_128(tf.keras.layers.Layer):
    ...
    def architecture(self):
        ...
        model += [Conv(self.channels, kernel=4, stride=2, pad=1, pad_type='reflect', use_bias=False, name='conv')]
        model += [Leaky_Relu(alpha=0.2,name='leaky_relu_7')]

        for i in range(3):
            model += [Conv(self.channels * 2, kernel=4, stride=2, pad=1, pad_type='reflect', use_bias=False, name='conv_' + str(i))]
            model += [BatchNorm(name='batch_norm_' + str(i))]
            if(i==0) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_8')]
            if(i==1) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_9')]
            if(i==2) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_10')]
        ...
        model += [Leaky_Relu(alpha=0.2,name='leaky_relu_11')]
        ...
        code_block += [Conv(self.channels, kernel=3, stride=1, pad=1, pad_type='reflect', use_bias=False, name='conv_code')]
        code_block += [BatchNorm(name='batch_norm_code')]
        code_block += [Leaky_Relu(alpha=0.2,name='leaky_relu_12')]
...
class Discriminator_256(tf.keras.layers.Layer):
    ...
    def architecture(self):
        ...
        model += [Conv(self.channels, kernel=4, stride=2, pad=1, pad_type='reflect', use_bias=False, name='conv')]
        model += [Leaky_Relu(alpha=0.2,name='leaky_relu_13')]

        for i in range(3):
            model += [Conv(self.channels * 2, kernel=4, stride=2, pad=1, pad_type='reflect', use_bias=False, name='conv_' + str(i))]
            model += [BatchNorm(name='batch_norm_' + str(i))]
            if(i==0) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_14')]
            if(i==1) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_15')]
            if(i==2) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_16')]
        ...
        for i in range(2):
            ...
            if(i==0) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_17')]
            if(i==1) :
                model += [Leaky_Relu(alpha=0.2,name='leaky_relu_18')]
        ...
        code_block += [Conv(self.channels, kernel=3, stride=1, pad=1, pad_type='reflect', use_bias=False, name='conv_code')]
        code_block += [BatchNorm(name='batch_norm_code')]
        code_block += [Leaky_Relu(alpha=0.2,name='leaky_relu_19')]
